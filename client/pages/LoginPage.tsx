...
import { Gamepad2, Mail, Lock, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-900 border border-white/10 rounded-3xl p-8 shadow-2xl space-y-8 animate-in zoom-in-95 duration-300">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-slate-400 mt-2">Log in to track your gaming journey</p>
        </div>
        ...
        <p className="text-center text-slate-500 text-sm">
          ...
          <Link to="/register" className="text-indigo-400 hover:text-indigo-300 font-bold transition-colors">Sign Up</Link>
        </p>
      </div>
    </div>
  );
